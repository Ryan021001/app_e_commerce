  ...
  try {
    ...
    const products = await Product.findAll({
      ...
      attributes: [
        ...
        'quantity',
        'image',
        [sequelize.fn('to_char', sequelize.col('createdAt'), 'YYYY-MM-DD HH24:MI:SS'), 'createdAt'],
        [sequelize.fn('to_char', sequelize.col('updatedAt'), 'YYYY-MM-DD HH24:MI:SS'), 'updatedAt'],
      ],
      include: [
        {
          model: ProductColor,
